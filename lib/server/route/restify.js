...
//var model = mongoose.model('User', new mongoose.Schema({accessToken: { type: String }}));
...
//Code modified to introduce token level security
function checkUser(req, cb){
