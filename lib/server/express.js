...
function _configure() {
  ...
  _server.configure('production', function () {
    _server.use('/components', express.static(path.join(_app.dir, '..', _app.project.path.client, 'components'), { maxAge: 31557600000 /* 1yr */ }));
    _server.use(express.static(path.join(_app.dir, '..', _app.project.path.dist), { maxAge: 31557600000 /* 1yr */ }));
    _server.use(express.errorHandler());
  });
